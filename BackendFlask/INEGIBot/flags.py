...
campos_filtro_dic = {'hombre':'POB84', 'mujer':'POB42', 'infantil':'POB8', 'joven':'POB11', 'adulto': '(POB14 + POB15) AS adulto', 'mayor':'POB23'}
str_filtro_dic = {'hombre':'de hombres', 'mujer':'de mujeres', 'infantil':'infantil(0-14)', 'joven':'de jovenes(15-29)', 'adulto': 'adulta(30-59)', 'mayor':'mayor(60+)'}
...
def flag_alert(json_flag, spark):
    ...
    df_mun = pd.read_csv('BackendFlask\INEGIBot\input\df_diccionario_mun.csv')
    filtro_list = ['hombre', 'mujer', 'infantil', 'joven', 'adulto', 'mayor']
    ...
    if filtro_flag == False and desglose_flag == False: #doble desglose general
        ...
        if json_flag['desglose'] == 'edad':  # aplicando desglose por edad
            ...
            message_str = "En 2020 la poblacion de hombres en %s era de %s y la de mujeres era de %s" % (nom_message,pob_hombres_message, pob_mujeres_message)
